...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      atendimentos_clientes: {
        Row: {
          ...
          relatorio: string
          remetentes_destinatarios: Json | null
          responsavel: string | null
          resumo: string | null
          situacao: string | null
          solicitacao: string
          tipo_atendimento: string | null
          uid_emails: Json | null
        }
        Insert: {
          anexos?: Json | null
          area_responsavel?: string | null
      ...
      crm_prospect_etapa_historico: {
        ...
        Relationships: [
          {
            foreignKeyName: 'crm_prospect_etapa_historico_prospect_id_fkey'
            columns: ['prospect_id']
            isOneToOne: false
            referencedRelation: 'crm_prospects'
            referencedColumns: ['id']
      ...
      handover_versoes: {
        ...
        Relationships: [
          {
            foreignKeyName: 'handover_versoes_implementacao_id_fkey'
            columns: ['implementacao_id']
            isOneToOne: false
            referencedRelation: 'implementacoes'
            referencedColumns: ['id']
      ...
      sl_historico_revisoes: {
        ...
        Relationships: [
          {
            foreignKeyName: 'sl_historico_revisoes_importacao_id_antiga_fkey'
            columns: ['importacao_id_antiga']
            isOneToOne: false
            referencedRelation: 'sl_importacoes'
            referencedColumns: ['id']
          },
          {
            foreignKeyName: 'sl_historico_revisoes_importacao_id_nova_fkey'
            columns: ['importacao_id_nova']
            isOneToOne: false
            referencedRelation: 'sl_importacoes'
            referencedColumns: ['id']
          },
          {
            foreignKeyName: 'sl_historico_revisoes_utilizacao_id_antigo_fkey'
            columns: ['utilizacao_id_antigo']
            isOneToOne: false
            referencedRelation: 'sl_utilizacao_mensal'
            referencedColumns: ['id']
          },
          {
            foreignKeyName: 'sl_historico_revisoes_utilizacao_id_novo_fkey'
            columns: ['utilizacao_id_novo']
            isOneToOne: false
            referencedRelation: 'sl_utilizacao_mensal'
            referencedColumns: ['id']
          },
      ...
      sl_utilizacao_mensal: {
        ...
        Relationships: [
          {
            foreignKeyName: 'sl_utilizacao_mensal_cliente_id_fkey'
            columns: ['cliente_id']
            isOneToOne: false
            referencedRelation: 'clientes'
            referencedColumns: ['id']
          ...
          {
            foreignKeyName: 'sl_utilizacao_mensal_importacao_id_fkey'
      ...
      vc_anexos: {
        Row: {
          ...
          descricao: string | null
          etapa_numero: number
          fonte_relacionada: string | null
          id: string
          nome_original: string
          pergunta_ou_item: string | null
          projeto_id: string
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_anexos_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: false
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
          },
        ]
      }
      vc_apuracao_historico: {
        Row: {
          created_at: string
          id: string
          motivo: string
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_apuracao_historico_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: false
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
      ...
      vc_apuracao_restrita: {
        Row: {
          aprovado_em: string | null
          aprovado_por: string | null
          base_anual_elegivel: number
          created_at: string
          fee_fixo_mensal: number
          id: string
          justificativa_financeiro: string | null
          meses_contrato: number
          modelo_comercial: string
          percentual_exito: number
          projeto_id: string
          remuneracao_fixa_total: number
          remuneracao_variavel_calculada: number
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_apuracao_restrita_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: true
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
      ...
      vc_etapas_dados: {
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_etapas_dados_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: false
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
      ...
      vc_importacoes_relatorios: {
        Row: {
          alteracoes_sugeridas: Json | null
          confirmado_em: string | null
          confirmado_por_id: string | null
          confirmado_por_nome: string | null
          created_at: string
          dados_brutos: Json | null
          etapas_afetadas: Json | null
          filial_identificada: string | null
          hash_arquivo: string
          ...
          totais_extraidos: Json | null
          updated_at: string
          usuario_envio_id: string | null
          usuario_envio_nome: string | null
          versao_leitura: string | null
        }
        Insert: {
          alteracoes_sugeridas?: Json | null
          confirmado_em?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_importacoes_relatorios_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: false
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
      ...
      vc_migracoes_locais: {
        Row: {
          ...
          id: string
          projeto_id: string
          total_anexos_migrados: number
          total_incompletos: number
          total_referencias_locais_mantidas: number
          total_registros: number
          total_sem_fonte: number
          usuario_id: string | null
          usuario_nome: string | null
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_migracoes_locais_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: false
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
      ...
      vc_perfis: {
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_perfis_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: false
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
      ...
      vc_trilha_auditoria: {
        ...
        Relationships: [
          {
            foreignKeyName: 'vc_trilha_auditoria_projeto_id_fkey'
            columns: ['projeto_id']
            isOneToOne: false
            referencedRelation: 'vc_projetos'
            referencedColumns: ['id']
    ...
    Functions: {
      ...
      sl_is_admin: { Args: never; Returns: boolean }
      sl_is_authorized_read: { Args: never; Returns: boolean }
      ...
      vc_can_access_project: {
        Args: { p_projeto_id: string }
        Returns: boolean
      }
      vc_can_approve_financeiro: { Args: never; Returns: boolean }
      vc_can_modify_storage_object: {
        Args: { p_operacao: string; p_storage_path: string }
        Returns: boolean
      }
      vc_can_read_restricted: { Args: never; Returns: boolean }
      vc_current_papel: { Args: never; Returns: string }
      vc_is_admin: { Args: never; Returns: boolean }
      vc_is_member: { Args: never; Returns: boolean }
    }
    Enums: {
      [_ in never]: never
    }
