...
export const MODULES = [
  ...
  { id: 'mod-frota-compras', name: 'Frota (Compras)', price: 250.0, implHours: 3 },
  { id: 'mod-frota-estoque', name: 'Frota (Estoque)', price: 250.0, implHours: 3 },
  { id: 'mod-frota-abastecimento', name: 'Frota (Abastecimento)', price: 250.0, implHours: 3 },
  { id: 'mod-frota-manutencao', name: 'Frota (Manutenção)', price: 250.0, implHours: 3 },
  { id: 'mod-frota-pneu', name: 'Frota (Pneu)', price: 250.0, implHours: 2 },
  { id: 'mod-frota-vencimento', name: 'Frota (Vencimento)', price: 250.0, implHours: 2 },
